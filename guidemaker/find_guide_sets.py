...
#                    continue
                ...
                # still need to add mechanism that stops searching candidates for matches
                # to a seed once we have hit a sequence with an expect < minexpect
    ...
    outfile = open(idtag + ".guideseqs", "w")
    for s in range(n_seeds):
